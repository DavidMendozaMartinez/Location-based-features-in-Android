...
public class MapsActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private void getCurrentPlaceLikelihoods() {
        ...
        placeResponse.addOnCompleteListener(this, task -> {
            if (task.isSuccessful()) {
                ...
                int count = Math.min(response != null ? response.getPlaceLikelihoods().size() : 0, M_MAX_ENTRIES);
    ...
    private final AdapterView.OnItemClickListener listClickedHandler = new AdapterView.OnItemClickListener() {
